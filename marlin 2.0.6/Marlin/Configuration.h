...
#define STRING_CONFIG_H_AUTHOR "(Genis_Aipel3dbcn@gmail.com)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //Sapphire Plus E3D Volcano Original 40W 24V
  #define DEFAULT_Kp 19.47
  #define DEFAULT_Ki 1.35
  #define DEFAULT_Kd 70.23
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 816 } //E3D Titan extruder
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27, 0, -2.04 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 150, 10, 10 }
